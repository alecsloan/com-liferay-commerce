...
public class CatalogItemSelectorViewDisplayContext
	...
	public SearchContainer<CommerceCatalog> getSearchContainer()
		...
		Sort sort = CommerceUtil.getCommerceCatalogSort(
		...
		int totalCatalogs = _commerceCatalogService.searchCommerceCatalogsCount(
			companyId, getKeywords());

		searchContainer.setTotal(totalCatalogs);
