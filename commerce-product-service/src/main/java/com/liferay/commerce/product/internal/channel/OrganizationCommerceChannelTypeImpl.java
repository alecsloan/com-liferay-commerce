...
@Component(
	immediate = true,
	property = {
		"commerce.product.channel.type.key=" + CommerceChannelConstants.TYPE_ORGANIZATION,
...
public class OrganizationCommerceChannelTypeImpl
	...
	public String getKey() {
		return CommerceChannelConstants.TYPE_ORGANIZATION;
	}

	@Override
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "organization");
	}
	...
	@Override
	public boolean isSatisfied(CommerceChannel commerceChannel)
