...
public class CPAttachmentFileEntryUtil {
	...
	* @throws NoSuchCPAttachmentFileEntryException if a matching cp attachment file entry could not be found
	*/
	public static CPAttachmentFileEntry findByF_C_C(long fileEntryId,
		long classNameId, long classPK)
		throws com.liferay.commerce.product.exception.NoSuchCPAttachmentFileEntryException {
		return getPersistence().findByF_C_C(fileEntryId, classNameId, classPK);
	}
	...
	* @return the matching cp attachment file entry, or <code>null</code> if a matching cp attachment file entry could not be found
	*/
	public static CPAttachmentFileEntry fetchByF_C_C(long fileEntryId,
		long classNameId, long classPK) {
		return getPersistence().fetchByF_C_C(fileEntryId, classNameId, classPK);
	}
	...
	*/
	public static CPAttachmentFileEntry fetchByF_C_C(long fileEntryId,
		...
		return getPersistence()
				   .fetchByF_C_C(fileEntryId, classNameId, classPK,
			retrieveFromCache);
	}
	...
	* @return the cp attachment file entry that was removed
	*/
	public static CPAttachmentFileEntry removeByF_C_C(long fileEntryId,
		long classNameId, long classPK)
		throws com.liferay.commerce.product.exception.NoSuchCPAttachmentFileEntryException {
		return getPersistence().removeByF_C_C(fileEntryId, classNameId, classPK);
	}
	...
	* @return the number of matching cp attachment file entries
	*/
	public static int countByF_C_C(long fileEntryId, long classNameId,
		long classPK) {
		return getPersistence().countByF_C_C(fileEntryId, classNameId, classPK);
	}
