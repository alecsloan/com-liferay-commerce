...
public class CPContentHelperImpl implements CPContentHelper {
	...
	public List<CPMedia> getImages(
		...
		if (cpMedias.isEmpty()) {
			FileEntry fileEntry = FileEntryUtil.fetchByPrimaryKey(
				_catalogCommerceMediaDefaultImage.getConfiguration(
	...
	@Reference(target = "(commerce.media.default.image.key=catalog)")
	private CommerceMediaDefaultImage _catalogCommerceMediaDefaultImage;
