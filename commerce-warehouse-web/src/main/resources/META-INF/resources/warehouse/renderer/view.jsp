...
page import="com.liferay.commerce.service.CommerceWarehouseLocalServiceUtil" %><%@
...
<%
	...
	List<CommerceWarehouse> commerceWarehouses = CommerceWarehouseLocalServiceUtil.searchCommerceWarehouses(themeDisplay.getCompanyId(), themeDisplay.getScopeGroupId(), latitude, longitude, -1, -1, null);
	...
	if (commerceOrder == null) {
		commerceOrder = CommerceOrderLocalServiceUtil.addCommerceOrder(commerceContext.getSiteGroupId(), commerceContext.getUserId(), commerceContext.getCommerceAccount().getCommerceAccountId());
	}
...
<div class="row">
	<h1 class="col-sm-12"><%= cpCatalogEntry.getName() %></h1>
